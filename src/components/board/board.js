        ...
        return (
            <div className="Board">
                <FadeIn 
                    ...
                    direction={'bottom'}
                    delay={'1s'}>
                    <h4>Try to click on every pokemon once. Once you click a player the grid will shuffle.<br/>Try not to click the same NBA Player twice or the game will start all over!</h4>
                </FadeIn>
                <FadeIn 
                    in={true}
                    duration={500}
